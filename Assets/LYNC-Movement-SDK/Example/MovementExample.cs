...
public class MovementExample : MonoBehaviour
{
    ...
    {
        Debug.Log("firebaseAuth.AptosFirebaseAuthData.publicKey"+firebaseAuth.AptosFirebaseAuthData.accountAddress);
        WalletAddressText.text = (firebaseAuth == null ? "Disconnected" : AbbreviateWalletAddressHex(firebaseAuth.AptosFirebaseAuthData.accountAddress));
