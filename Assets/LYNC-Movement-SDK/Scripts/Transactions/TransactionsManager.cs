    ...
    public class TransactionsManager
    {
        public async Task<TransactionResult> SendTransaction(Transaction transaction)
        {
            ...
            if (AuthBase.Instance is FirebaseAuth) // Server transactions
            {
                ...
                txData =>
                {
                    LyncManager.Instance.SendTransactionAnalytics(AuthBase.Instance.accountAddress, txData.data.transactionHash, LyncManager.Instance.SponsorTransaction?"Gasless":"UserPaid");
